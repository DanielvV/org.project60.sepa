...
class CRM_Admin_Form_Setting_SepaSettings extends CRM_Admin_Form_Setting
{
    ...
    function __construct() {
       ...
       $this->config_fields = array(
                         ...
                         array('batching.limit.count',      ts('Limit&nbsp;Count&nbsp;Batch', array('domain' => 'org.project60.sepa')), array('size' => 2)),
                         array('batching.limit.amount',     ts('Limit&nbsp;Amount&nbsp;Batch', array('domain' => 'org.project60.sepa')), array('size' => 2)),
                         array('batching.limit.amount.single',    ts('Limit&nbsp;Amount&nbsp;Single', array('domain' => 'org.project60.sepa')), array('size' => 2)),
      ...
      $this->custom_fields = array(
                         ...
                         array('custom_limit_count_batch',      ts('Limit&nbsp;Count&nbsp;Batch', array('domain' => 'org.project60.sepa')), array('size' => 2)),
                         array('custom_limit_amount_batch',     ts('Limit&nbsp;Amount&nbsp;Batch', array('domain' => 'org.project60.sepa')), array('size' => 2)),
                         array('custom_limit_amount_single',    ts('Limit&nbsp;Amount&nbsp;Single', array('domain' => 'org.project60.sepa')), array('size' => 2)),
